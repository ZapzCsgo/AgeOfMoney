...
export function InfoTooltip({ content, width = 240 }: { content: string; width?: number }) {
  ...
  return (
    <span ref={wrapRef} className="relative inline-flex">
      ...
      {open && (
        <span
          className="absolute left-1/2 -translate-x-1/2 mt-3 rounded-md px-3 py-2 z-30 pointer-events-none text-[11px] leading-relaxed normal-case tracking-normal bg-tft-bg-elevated border border-tft-border-mid text-tft-text-dim"
          style={{
            top: '100%',
            width,
