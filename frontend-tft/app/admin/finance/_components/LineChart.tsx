 ...
 *
 * Defaults use the arcane purple-bright accent so a chart in the user/
 * growth section reads as "tft.money" without further configuration.
 */
...
export function LineChart({
  ...
  if (points.length === 0) {
    return (
      <div
        className="flex items-center justify-center rounded-md text-[11px] text-tft-text-muted"
