...
const Particles = nextDynamic(() => import('@/components/magicui/particles').then(m => ({ default: m.Particles })), { ssr: false });
const GridPattern = nextDynamic(() => import('@/components/magicui/grid-pattern').then(m => ({ default: m.GridPattern })), { ssr: false });
